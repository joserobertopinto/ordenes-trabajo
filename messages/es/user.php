...
//   'Your account has been created and a message with further instructions has been sent to your email' => 'Su cuenta ha sido creada y se ha enviado un mensaje con más instrucciones a su correo electrónico.',
  'Your account has been created and a message with further instructions has been sent to your email' => 'Su usuario se ha generado con éxito, haga click en <a href="'. Yii::$app->urlManager->createUrl(['user/login']).'">ingresar al sistema</a',
